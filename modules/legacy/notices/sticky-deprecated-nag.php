...
class Sticky_Deprecated_Nag extends Notice_Base {
	...
	public function content(): string {
		return sprintf( '<h4>%s</h4><p>%s<a href="%s">%s</a></p><p><a class="button button-primary" href="%s">%s</a></p>',
			...
			__( 'Your current plugin is no longer supported. Switch to {{appName}} by Elementor now to access more customization, control, and tools for a more inclusive site.', 'pojo-accessibility' ),
