...
class Quota_100 extends Notice_Base {
	...
	public function content(): string {
		return sprintf( '<h3>%s</h3><p>%s</p><p><a class="button button-primary" style="background-color: #93003F; border-color: #93003F;" href="%s">%s</a></p>',
			...
			__( 'Upgrade now to increase your plan’s monthly widget loads limit and ensure all accessibility features stay fully available for every visitor.', 'pojo-accessibility' ),
